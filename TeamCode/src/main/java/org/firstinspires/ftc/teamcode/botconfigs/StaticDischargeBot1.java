...
public class StaticDischargeBot1 {
    ...
    public StaticDischargeBot1(Telemetry tele, HardwareMap map) {
        DcMotorWrap frontRightMotor = new DcMotorWrap(tele, map, "0", 3, 1.25, 0.8, 1120);
        DcMotorWrap backRightMotor = new DcMotorWrap(tele, map, "3", 3, 1.25, 0.8, 1120);
        DcMotorWrap frontLeftMotor = new DcMotorWrap(tele, map, "1", 3, 1.25, 0.8, 1120);
        DcMotorWrap backLeftMotor = new DcMotorWrap(tele, map, "2", 3, 1.25, 0.8, 1120);
